...
@QuarkusTest
public class Day24Test extends AocTest {
    ...
    public void textExample() throws IOException {
        ...
        assertEquals(2024, solver.calculatePart1(input) );
    }  
    @Test
    public void textExampleSmall() throws IOException {
        List<String> input = readAllLine("example-small.txt");

        assertEquals(4, solver.calculatePart1(input) );
    }
//    
//    @Test
